...
- Distribute modified versions of the Software as standalone applications
- Remove or alter copyright notices or license terms
- Use the Software in products or services that generate revenue
...
- Advertising or promotional content for commercial products
- Integration into commercial software

Please contact the project maintainers for a Commercial License.

### Creative Assets

Note: Creative assets (shaders, examples, documentation) are licensed separately under CC BY-NC-SA 4.0. See creative/LICENSE.md.
...
For licensing inquiries, please open an issue on the project repository.
